---
name: problem-fix
description: "Problem Fix for node. 19 error→fix pairs."
domain: problem-fix
composesFrom:
  - fix
triggers:
...
| `+ - Fixed null crash in UpsellStore — prevents nul` | problem-fix in agent-rules.md | 3x |
...
---
*Auto-generated by BrainSync 🧠 | 2 patterns | 2026-04-09*
