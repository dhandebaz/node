...
export const comparisonCategories: Record<string, ComparisonCategory> = {
  ai: {
    ...
    icon: Bot,
    features: [
      { name: "Domain-Specific AI Agents", nodebase: true, competitor: false, note: "Omni AI, Nurse AI, Dukan AI, Thrift AI" },
  ...
  messaging: {
    ...
    features: [
      ...
      { name: "Partner Network Integrations", nodebase: true, competitor: false },
      { name: "Channel Ecosystem Sync", nodebase: true, competitor: false },
