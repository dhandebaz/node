...
export const industries: Industry[] = [
  {
    ...
    slug: "hospitality",
    icon: Building2,
    tagline: "For Airbnb hosts, hotels, and vacation rentals",
    description: "NodeBase transforms hospitality operations with AI that understands guest communication, booking management, and check-in automation.",
    targetCustomer: "Airbnb hosts, vacation rental managers, boutique hotels, homestay operators",
    painPoints: [
      "24/7 guest messaging overload",
    ...
    features: [
      {
        ...
        description: "AI handles booking inquiries, availability checks, and confirmation messages across Airbnb, Booking.com, and direct bookings.",
        icon: Calendar,
      },
      {
        title: "Smart Guest Communication",
        description: "Instant responses to common questions about parking, WiFi, check-in times, and local recommendations.",
        icon: MessageSquare,
      },
      {
        title: "KYC & Guest Verification",
        description: "Automated ID verification with Nodebase Eyes OCR. Aadhaar numbers automatically masked for compliance.",
        icon: ShieldCheck,
      },
      {
        title: "Payment Collection",
        description: "Generate Razorpay payment links for deposits and balance payments. AI follows up on pending payments.",
        icon: CreditCard,
      },
      {
        title: "Review Management",
        description: "AI drafts personalized review responses. Identifies guests who may leave negative reviews for proactive resolution.",
        icon: Bot,
      },
      {
        title: "Voice Inquiries",
        description: "Nodebase Voice handles phone inquiries when you're unavailable. Never miss a booking opportunity.",
        icon: Phone,
      },
    ],
    caseStudy: {
      business: "GreenView Stays",
      type: "Airbnb Host - 8 Properties",
      result: "70% reduction in response time",
      metric: "From 2 hours to 5 minutes average response",
    },
    aiAgent: {
      name: "Host AI",
      description: "Premium hospitality AI that handles guest communication, booking coordination, and check-in automation.",
      capabilities: [
        "Answers property questions instantly",
        "Sends booking confirmations",
        "Collects deposits via payment links",
        "Coordinates check-in details",
        "Handles review responses",
        "Escalates complex requests",
      ],
    },
    competitors: ["B下来", "Guesty", "PriceLabs"],
  },
  {
    id: "healthcare",
    name: "Healthcare",
