    ...
    <Card className="bg-transparent border-border">
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-foreground">AI Memory (Beta)</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between p-4 rounded-lg bg-black/20 border border-white/5">
          <div className="space-y-0.5">
            <Label className="text-foreground text-base">Enable Memory</Label>
        ...
        {isEnabled && (
          <div className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="flex gap-2">
              ...
              >
                <SelectTrigger className="w-[140px] bg-black/20 border-border text-foreground">
              ...
              <Input 
                ...
                className="bg-black/20 border-border text-foreground placeholder:text-foreground/20"
                  ...
                  >
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        {memory.confidence < 1 && (
                            <span className="text-[10px] text-foreground/30" title="Confidence">
                    ...
                    <Button
                      ...
                      disabled={isPending}
                      className="opacity-0 group-hover:opacity-100 h-8 w-8 text-foreground/40 hover:text-red-400 hover:bg-red-500/10 transition-all"
                    >
