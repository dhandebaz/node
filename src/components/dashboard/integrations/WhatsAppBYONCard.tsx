            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                {status === 'connected' ? (
                  ...
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-white/5 text-[var(--public-muted)] border border-[var(--public-line)]">
        ...
        <div className="w-full md:w-[400px] bg-[var(--public-bg-soft)] rounded-lg border border-[var(--public-line)] p-5 flex flex-col items-center justify-center min-h-[200px]">
          {status === 'connected' ? (
            ...
            <div className="space-y-4 text-center w-full">
              ...
              <p className="text-xs text-[var(--public-muted)]">Open WhatsApp &gt; Linked Devices &gt; Link a Device</p>
              <div className="flex items-center justify-center gap-2 text-xs text-[var(--public-muted)] animate-pulse">
