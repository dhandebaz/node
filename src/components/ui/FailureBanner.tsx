...
export function FailureBanner() {
  ...
  const getColor = (severity: string, category: string) => {
    if (category === "system")
      return "bg-red-600 border-red-700 text-white shadow-lg shadow-red-500/20";
    ...
    if (f.category === "system") {
      return (
        <a
          ...
          className="text-xs bg-white text-red-600 px-2 py-0.5 rounded font-bold ml-3 hover:bg-zinc-100"
        >
          Contact Support
        </a>
      );
        ...
        <div className="px-4 py-3 rounded-lg border flex items-start gap-3 bg-red-600 border-red-700 text-white shadow-lg shadow-red-500/20 animate-pulse">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm opacity-90">
              We are currently performing emergency maintenance. Some features
              (AI, Payments) may be unavailable.
            </div>
          </div>
        </div>
      )}
