    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="space-y-4">
        {paymentMethods.map((pm) => (
          <div key={pm.id} className="public-panel border border-border rounded-xl p-6 flex items-center justify-between group">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-muted text-foreground rounded-lg border border-border">
                <CreditCard className="w-6 h-6 text-muted-foreground" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-medium text-foreground capitalize">{pm.brand}</h3>
                  {pm.isDefault && (
                ...
                <p className="text-sm text-muted-foreground">Ending in •••• {pm.last4}</p>
              </div>
            </div>
        ...
        <button className="w-full py-4 border border-dashed border-border hover:border-zinc-500 rounded-xl flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground hover:public-panel/50 transition-all group">
          <div className="p-1 rounded-full bg-muted group-hover:bg-zinc-700">
