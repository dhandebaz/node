    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            Manage your AI credits and view consumption history.
          </p>
        </div>
        <button
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold">
                {usage24h.toFixed(2)} Credits
              </h3>
            </div>
          </div>
          <p className="text-xs text-gray-400">
            Total cost incurred in last 24 hours.
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Starter */}
          <div
            className={`border rounded-xl p-6 ${plan === "starter" ? "border-black bg-gray-50" : "border-gray-200"}`}
          >
            ...
            {plan === "starter" ? (
              ...
              <button
                disabled
                className="w-full py-2 border border-gray-300 rounded-lg font-medium text-gray-500 cursor-not-allowed"
              >
                Default
              </button>
            )}
          ...
          {/* Pro */}
          <div
            className={`border rounded-xl p-6 ${plan === "pro" ? "border-black bg-gray-50" : "border-gray-200"}`}
          >
            <div className="flex justify-between items-center">
          ...
          {/* Business */}
          <div
            className={`border rounded-xl p-6 ${plan === "business" ? "border-black bg-gray-50" : "border-gray-200"}`}
          >
            <div className="flex justify-between items-center">
