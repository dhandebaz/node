    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full bg-muted/50 text-foreground border border-border rounded-lg px-4 py-2 focus:outline-none focus:border-primary cursor-not-allowed opacity-70"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--public-muted)] mb-2">
        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between p-4 bg-muted/30 text-foreground rounded-lg border border-border">
              <div>
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 text-foreground rounded-lg border border-border">
              ...
              <div
                className="relative inline-flex h-6 w-11 items-center rounded-full bg-primary cursor-pointer opacity-50 cursor-not-allowed"
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-muted/30 text-foreground rounded-lg border border-border">
                ...
                <div className="text-xs text-green-600 font-medium px-2 py-1 bg-green-500/10 rounded border border-green-500/20">
                  Active Now
                </div>
              </div>
              <div className="flex items-center justify-between p-4 bg-muted/30 text-foreground rounded-lg border border-border">
                ...
                <button className="text-xs text-red-500 hover:text-red-400 font-medium px-2 py-1 hover:bg-red-500/10 rounded transition-colors border border-transparent hover:border-red-500/20">
                  Revoke
                </button>
              </div>
            </div>
