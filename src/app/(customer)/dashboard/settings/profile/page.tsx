...
export default function ProfileSettingsPage() {
  ...
  return (
    <div className="space-y-8 pb-24 md:pb-0">
      <div>
        <h1 className="text-2xl font-bold text-foreground mb-1">Profile & KYC</h1>
      ...
      <div className="dashboard-surface p-6 space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-white/5 border border-border rounded-xl p-4">
            ...
            <div className="text-foreground mt-2 capitalize">
          ...
          <div className="bg-white/5 border border-border rounded-xl p-4">
            ...
            <div className="text-foreground mt-2">Encrypted</div>
          </div>
        </div>
