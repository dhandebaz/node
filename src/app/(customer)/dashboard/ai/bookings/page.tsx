  ...
  const statusDisplay = (status: string) => {
    ...
    if (status === "draft") {
      return {
        ...
        badge: "bg-white/5 text-foreground/50",
      };
    }
    ...
    return {
      ...
      badge: "bg-white/5 text-foreground/60",
    };
  };
  ...
  return (
    <div className="space-y-6 pb-24 md:pb-0">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.3fr_1fr] gap-6">
        <div className="bg-transparent border border-border rounded-2xl overflow-hidden flex flex-col h-[70vh]">
          <div className="p-4 border-b border-border flex items-center justify-between sticky top-0 bg-transparent/95 backdrop-blur z-10">
            <div className="text-sm font-semibold text-foreground">
              {labels.bookings} list
            </div>
          </div>
          {error && <div className="p-6 text-sm text-foreground/50">{error}</div>}
          ...
          {!loading && !error && filteredBookings.length === 0 && (
            <div className="flex flex-col items-center justify-center p-12 text-center border border-dashed border-border rounded-xl bg-white/5 mt-4 mx-6">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-foreground/40">{listingName}</div>
        ...
        <div className="bg-transparent border border-border rounded-2xl p-4 space-y-4">
          <div className="text-sm font-semibold text-foreground">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="bg-white/5 border border-border rounded-lg p-3">
                  <div className="text-foreground/40">Amount</div>
                ...
                <div className="bg-white/5 border border-border rounded-lg p-3">
                  <div className="text-foreground/40">Payment</div>
                  <div className="text-foreground mt-1">
                    {detail.payment?.status || "not created"}
                  </div>
                </div>
                <div className="bg-white/5 border border-border rounded-lg p-3">
                  <div className="text-foreground/40">Source</div>
                  <div className="text-foreground mt-1">
              ...
              <div className="bg-white/5 border border-border rounded-lg p-3 space-y-2">
                <div className="text-xs text-foreground/40">Payment link</div>
                {detail.payment?.payment_link ? (
                  <a
                    href={detail.payment.payment_link}
                    target="_blank"
                    rel="noreferrer"
                    className="text-xs text-foreground/80 inline-flex items-center gap-2"
                  >
                    <ExternalLink className="w-3 h-3" />
                    Open Razorpay link
                  </a>
                ) : (
                  <div className="text-xs text-foreground/50">Not generated yet</div>
                )}
              </div>

              <div className="bg-white/5 border border-border rounded-lg p-3 space-y-1">
                <div className="text-xs text-foreground/40">Linked conversation</div>
                <div className="text-xs text-foreground/60">Not linked yet</div>
              </div>

              <div className="flex flex-wrap gap-2">
                <button
                  onClick={handleCancelBooking}
                  className="px-3 py-1.5 text-xs font-semibold border border-white/20 text-foreground/70 rounded-full"
                >
                  Cancel {labels.booking.toLowerCase()}
                </button>
              </div>

              <div className="bg-white/5 border border-border rounded-lg p-3 space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-xs text-foreground/40">ID Verification</div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="relative border border-border rounded-lg overflow-hidden">
                        {idRecord.back_image_path ? (
                          ...
                          <div className="min-h-[160px] bg-black/20 flex items-center justify-center text-xs text-foreground/40">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <button
                        ...
                        className="text-xs px-3 py-1.5 rounded-full border border-white/20 text-foreground/80"
                      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="bg-transparent border border-border rounded-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              ...
              {idMessage && (
                <div className="text-xs text-foreground/60">{idMessage}</div>
              )}
            </div>
            <div className="p-4 border-t border-border flex items-center justify-between">
              <div className="text-[10px] text-foreground/40">
