...
export default async function InvitePage() {
  ...
  const referralLink = `${getAppUrl()}/signup?ref=${referralCode}`;
            ...
            <div className="space-y-4">
              {stats.history.map((referral: any) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`p-2 rounded-full ${referral.status === "rewarded" ? "bg-green-500/20 text-green-400" : "bg-yellow-500/20 text-yellow-400"}`}
                    >
