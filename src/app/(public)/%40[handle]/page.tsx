      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <section className="public-panel px-6 py-8 sm:px-8 sm:py-10">
          <div className="relative z-10 grid gap-6 lg:grid-cols-[auto_minmax(0,1fr)] lg:items-center">
            <div className="public-inset flex h-24 w-24 items-center justify-center rounded-[2rem] bg-primary text-3xl font-bold text-white">
              {initials || "NB"}
            </div>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-3 text-base capitalize leading-7 text-muted-foreground">
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,0.9fr)]">
          <section className="public-panel p-6 sm:p-8">
            <div className="relative z-10 space-y-5">
              <div>
                ...
                <h2 className="public-display mt-3 text-3xl text-foreground">
              ...
              <div className="grid gap-3">
                {tenant.owner_user_id ? (
                  <Link
                    ...
                    className="public-inset flex items-center justify-between rounded-[1.3rem] px-4 py-4 text-sm font-semibold text-foreground"
                  >
                    <span className="flex items-center gap-3">
                      <MessageSquareShare className="h-4 w-4 text-primary" />
                      Open direct chat
                    </span>
                    <span className="public-pill text-xs font-semibold text-muted-foreground">
                      Messaging portal
                    </span>
                  </Link>
                ) : null}
          ...
          <section className="public-panel-soft p-6">
            <div className="space-y-4">
              ...
              <div className="rounded-[1.4rem] border border-border bg-[rgba(255,248,235,0.78)] p-4">
