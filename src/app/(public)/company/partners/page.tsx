  ...
  return (
    <div className="bg-black min-h-screen text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-white/20 rounded-full blur-3xl opacity-30"></div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
            <div className="glass-card p-8 rounded-2xl text-center hover:bg-white/5 transition-colors">
              ...
              <Link href="/company/partners/system-integrators" className="inline-block px-6 py-2 rounded-full border border-white/10 hover:bg-white/10 transition-colors text-sm font-medium">
                Become an SI Partner
              </Link>
            </div>

            <div className="glass-card p-8 rounded-2xl text-center hover:bg-white/5 transition-colors">
              <div className="w-16 h-16 mx-auto bg-brand-saffron/10 rounded-2xl flex items-center justify-center mb-6">
              ...
              <Link href="/company/partners/technology" className="inline-block px-6 py-2 rounded-full border border-white/10 hover:bg-white/10 transition-colors text-sm font-medium">
                Build Integration
              </Link>
            </div>

            <div className="glass-card p-8 rounded-2xl text-center hover:bg-white/5 transition-colors">
              <div className="w-16 h-16 mx-auto bg-brand-green/10 rounded-2xl flex items-center justify-center mb-6">
              ...
              <Link href="/company/partners/hardware" className="inline-block px-6 py-2 rounded-full border border-white/10 hover:bg-white/10 transition-colors text-sm font-medium">
                Certify Hardware
              </Link>
            </div>
          </div>
